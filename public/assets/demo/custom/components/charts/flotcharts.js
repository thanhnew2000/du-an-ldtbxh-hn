...
var FlotchartsDemo = function() {
    ...
    var demo2 = function() {
        ...
        var pageviews = JSON.parse($('#m_flotcharts_2').attr('tuyen_sinh'));
        var visitors = JSON.parse($('#m_flotcharts_2').attr('tot_nghiep'));;
    ...
    var demo8 = function() {
        var data = JSON.parse($('#m_flotcharts_8').attr('attr'));
