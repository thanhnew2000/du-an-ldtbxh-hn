...
<form action="{{route('import-error-quan-ly-giao-vien')}}" id="form_import" method="post" enctype="multipart/form-data">
    @csrf
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Hủy</button>
                    <button type="button" class="btn btn-primary" onclick="closeModal('closeImportFile')"
                        id="submitTai">Tải</a>
