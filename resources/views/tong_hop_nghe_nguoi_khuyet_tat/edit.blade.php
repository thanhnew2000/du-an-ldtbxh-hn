...
<div class="m-content container-fluid">
    <form action="{{route('nhapbc.dao-tao-khuyet-tat.update',['id'=>$data->id])}}" id="validate-form" method="post"
        class="m-form pt-5">
        @csrf
        <div class="m-portlet mt-5">
                        ...
                        <div class="row col-12">
                            <div class="col-md-3">
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="number" value="{{$data->tong_ngan_sach}}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="number" value="{{$data->ngan_sach_TW}}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="number" value="{{$data->ngan_sach_TP}}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="number" value="{{$data->ngan_sach_khac}}"
                                            class="form-control m-input" placeholder="Nhập vào số"
                                            name="ngan_sach_khac">
                                ...
                                <div class="row col-12">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-lg-7">
                                                <input type="number" value="{{$data->tuyen_sinh_nu}}"
                                                    class="form-control m-input" placeholder="Nhập vào số"
                                                    name="tuyen_sinh_nu">
                                                @error('tuyen_sinh_nu')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-lg-7">
                                                <input type="number" value="{{$data->tuyen_sinh_ho_khau_HN}}"
                                                    class="form-control m-input" placeholder="Nhập vào số"
                                ...
                                <div class="row col-12">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <label class="col-lg-5 col-form-label">Nữ</label>
                                            <div class="col-lg-7">
                                                <input type="number" value="{{$data->tot_nghiep_nu}}"
                                                    class="form-control m-input" placeholder="Nhập vào số"
                                                    name="tot_nghiep_nu">
                                                @error('tot_nghiep_nu')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                        ...
                                        <div class="form-group m-form__group row">
                                            <label class="col-lg-5 col-form-label">Hộ khẩu Hà Nội</label>
                                            <div class="col-lg-7">
                                                <input type="number" value="{{$data->tot_nghiep_ho_khau_HN}}"
                                                    class="form-control m-input" placeholder="Nhập vào số"
            ...
            <div class="d-flex justify-content-end">
                <div class="col-lg-1 ">
                    <a href="{{route('nhapbc.dao-tao-khuyet-tat.show',['id'=>$data->co_so_id])}}"
