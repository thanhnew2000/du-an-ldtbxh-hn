                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="number"
                                                        value="{{$data_tuyen_sinh_id->Tong_SoNguoi_TN}}"
                                            ...
                                            <tr>
                                                <td>Tốt nghiệp Nữ</td>
                                                <td><input type="number" value="{{$data_tuyen_sinh_id->HoKhauHN}}"
                                                        step="1" name="HoKhauHN" class="form-control m-input">
                                                    @error('HoKhauHN')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </td>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="number"
                                                        ...
                                                        name="SoSV_NhapHoc_DauKhoa_TrinhDoCD"
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number"
                                                        ...
                                                        name="SoSV_Du_DieuKienThi_XetTN_TrinhDoCD"
                                                        class="form-control m-input">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="number"
                                                        ...
                                                        name="SoSV_NhapHoc_DauKhoa_TrinhDoSC"
                                                        class="form-control m-input">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number"
                                                        ...
                                                        name="SoSV_Du_DieuKienThi_XetTN_TrinhDoSC"
                                                        class="form-control m-input">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="number"
                                                        ...
                                                        name="SoSV_NhapHoc_DauKhoa_TrinhDoTC"
                                                        class="form-control m-input">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number"
                                                        ...
                                                        name="HoKhau_HN_Thuoc_DoiTuong_TN_TC"
                                                        class="form-control m-input">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="number"
                                                        ...
                                                        name="SoSV_NhapHoc_DauKhoa_NgheKhac"
                                                        class="form-control m-input">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number"
                                                        ...
                                                        name="SoSV_DuKienThi_XetTN_NgheKhac"
                                                        class="form-control m-input">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number"
                                                        ...
                                                        name="DanToc_ThieuSo_ItNguoi_NgheKhac"
                                                        class="form-control m-input">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="number"
                                                        ...
                                                        name="SoNguoi_CoViecLamNgay_SauKhi_TN_CD"
                                                        class="form-control m-input">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number"
                                                        ...
                                                        name="CoViecLam_HoKhauHN_TrinhDoCD"
                                                        class="form-control m-input">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="number"
                                                            ...
                                                            name="CoViecLam_HoKhauHN_TrinhDo_TC"
                                                            class="form-control m-input">
