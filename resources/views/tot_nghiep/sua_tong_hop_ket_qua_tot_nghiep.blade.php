                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->Tong_SoNguoi_TN}}" name="Tong_SoNguoi_TN"
                                                class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Tổng số nữ</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->NU_SV_TN}}" name="NU_SV_TN"
                                                class="form-control"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->DanToc_ThieuSo_ItNguoi}}"
                                                name="DanToc_ThieuSo_ItNguoi" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Tốt nghiệp Nữ</td>
                                        <td><input type="number" min="0" value="{{$data_tuyen_sinh_id->HoKhauHN}}"
                                                step="1" name="HoKhauHN" class="form-control"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="number" min="0" step="1"
                                                ...
                                                name="SoSV_NhapHoc_DauKhoa_TrinhDoCD" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Số sinh viên đủ điều kiện thi sét TN</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoSV_Du_DieuKienThi_XetTN_TrinhDoCD}}"
                                                name="SoSV_Du_DieuKienThi_XetTN_TrinhDoCD" class="form-control"></td>

                                    </tr>
                                    <tr>
                                        <td>Số sinh viên tốt nghiệp</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoSV_TN_TrinhDoCD}}"
                                                name="SoSV_TN_TrinhDoCD" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Tốt nghiệp Nữ</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoLuong_Nu_SV_CD}}"
                                                name="SoLuong_Nu_SV_CD" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Dân tộc thiểu số ít người</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->DanToc_ThieuSo_ItNguoi_CD}}"
                                                name="DanToc_ThieuSo_ItNguoi_CD" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Hộ khẩu Hà Nội</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoSV_HoKhauHN_CD}}"
                                                name="SoSV_HoKhauHN_CD" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Số HSSV tốt nghiệp khá, giỏi</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoLuong_HSSV_TN_Kha_Gioi_CD}}"
                                                name="SoLuong_HSSV_TN_Kha_Gioi_CD" class="form-control"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="number" min="0" step="1"
                                                ...
                                                name="SoSV_NhapHoc_DauKhoa_TrinhDoSC" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Số sinh viên đủ điều kiện thi sét TN</td>
                                        <td><input type="number" min="0" step="1"
                                    ...
                                    <tr>
                                        <td>Số sinh viên tốt nghiệp</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoSV_TN_TrinhDoSC}}"
                                                name="SoSV_TN_TrinhDoSC" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Tốt nghiệp Nữ</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoLuong_Nu_SV_SC}}"
                                                name="SoLuong_Nu_SV_SC" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Dân tộc thiểu số ít người</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->DanToc_ThieuSo_ItNguoi_SC}}"
                                                name="DanToc_ThieuSo_ItNguoi_SC" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Hộ khẩu Hà Nội</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoSV_HoKhauHN_SC}}"
                                                name="SoSV_HoKhauHN_SC" class="form-control"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="number" min="0" step="1"
                                                ...
                                                name="SoSV_NhapHoc_DauKhoa_TrinhDoTC" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Số sinh viên đủ điều kiện thi sét TN</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoSV_Du_DieuKienTHhi_XetTN_TrinhDoTC}}"
                                                name="SoSV_Du_DieuKienTHhi_XetTN_TrinhDoTC" class="form-control"></td>

                                    </tr>
                                    <tr>
                                        <td>Số sinh viên tốt nghiệp</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoSV_TN_TrinhDoTC}}"
                                                name="SoSV_TN_TrinhDoTC" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Tốt nghiệp Nữ</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoLuong_Nu_SV_TC}}"
                                                name="SoLuong_Nu_SV_TC" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Dân tộc thiểu số ít người</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->DanToc_ThieuSo_ItNguoi_TC}}"
                                                name="DanToc_ThieuSo_ItNguoi_TC" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Hộ khẩu Hà Nội</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoSV_HoKhauHN_TC}}"
                                                name="SoSV_HoKhauHN_TC" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Trong đó hộ khẩu Hà Nội thuộc đối tượng tốt nghiệp THCS</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->HoKhau_HN_Thuoc_DoiTuong_TN_TC}}"
                                                name="HoKhau_HN_Thuoc_DoiTuong_TN_TC" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Số HSSV tốt nghiệp khá, giỏi</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoLuong_HSSV_TN_Kha_Gioi_TC}}"
                                                name="SoLuong_HSSV_TN_Kha_Gioi_TC" class="form-control"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="number" min="0" step="1"
                                                ...
                                                name="SoSV_NhapHoc_DauKhoa_NgheKhac" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Số sinh viên đủ điều kiện thi sét TN</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoSV_DuKienThi_XetTN_NgheKhac}}"
                                                name="SoSV_DuKienThi_XetTN_NgheKhac" class="form-control"></td>

                                    </tr>
                                    <tr>
                                        <td>Số sinh viên tốt nghiệp</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoSV_TN_NgheKhac}}"
                                                name="SoSV_TN_NgheKhac" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Tốt nghiệp Nữ</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoLuong_Nu_SV_NgheKhac}}"
                                                name="SoLuong_Nu_SV_NgheKhac" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Dân tộc thiểu số ít người</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->DanToc_ThieuSo_ItNguoi_NgheKhac}}"
                                                name="DanToc_ThieuSo_ItNguoi_NgheKhac" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Hộ khẩu Hà Nội</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->SoNguoi_HoKhauHN_NgheKhac}}"
                                                name="SoNguoi_HoKhauHN_NgheKhac" class="form-control"></td>
                                    </tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="number" min="0" step="1"
                                                ...
                                                name="SoNguoi_CoViecLamNgay_SauKhi_TN_CD" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Hộ khẩu Hà Nội</td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->CoViecLam_HoKhauHN_TrinhDoCD}}"
                                                name="CoViecLam_HoKhauHN_TrinhDoCD" class="form-control"></td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" min="0" step="1"
                                                ...
                                                name="SoLuong_HoKhauHN_TrinhDoSC" class="form-control"></td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" min="0" step="1"
                                                ...
                                                name="CoViecLam_HoKhauHN_TrinhDo_TC" class="form-control"></td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" min="0" step="1"
                                                ...
                                                name="SoNguoi_HoKhauHN_TrinhDo_DaoTao_NgheKhac" class="form-control">
                                        </td>
                            ...
                            <table class="table m-table m-table--head-bg-brand">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->MucLuong_TB_CD}}" name="MucLuong_TB_CD"
                                                class="form-control"></td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->MucLuong_TB_TC}}" name="MucLuong_TB_TC"
                                                class="form-control"></td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->MucLuong_TB_SC}}" name="MucLuong_TB_SC"
                                                class="form-control"></td>
                                        <td><input type="number" min="0" step="1"
                                                value="{{$data_tuyen_sinh_id->MucLuong_TB_NgheKhac}}"
                                                name="MucLuong_TB_NgheKhac" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <td>Hộ khẩu Hà Nội</td>
                                        <td><input type="number" min="0" step="1"
