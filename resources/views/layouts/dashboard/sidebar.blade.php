...
<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-light ">
	...
	<div id="m_ver_menu"
		...
		<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
				...
				<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
					<ul class="m-menu__subnav">
						...
						<li class="m-menu__item " aria-haspopup="true"><a
								href="{{route('nhapbc.dao-tao-nghe-doanh-nghiep')}}" class="m-menu__link "><i
									class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
			...
			{{-- <li class="m-menu__item m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a
				...
				<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
					<ul class="m-menu__subnav">
						...
						<li class="m-menu__item " aria-haspopup="true"><a href="{{route('xuatbc.ds-sv-dang-hoc')}}"
								class="m-menu__link "><i
									class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
						...
						<li class="m-menu__item " aria-haspopup="true"><a
								href="{{route('xuatbc.ds-dao-tao-khuyet-tat')}}" class="m-menu__link "><i
									class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
									class="m-menu__link-text">Tổng hợp đào tạo nghề cho người khuyết tật</span></a></li>
						<li class="m-menu__item " aria-haspopup="true"><a
								href="{{route('xuatbc.ds-dao-tao-thanh-nien')}}" class="m-menu__link "><i
									class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
									class="m-menu__link-text">Tổng hợp đào tạo nghề cho thanh niên</span></a></li>
						<li class="m-menu__item " aria-haspopup="true"><a
								href="{{route('xuatbc.ds-dao-tao-voi-doanh-nghiep')}}" class="m-menu__link "><i
									class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
			...
			<li class="m-menu__item m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a
					href="javascript:;" class="m-menu__link m-menu__toggle"><i
						class="m-menu__link-icon flaticon-interface-1"></i><span class="m-menu__link-text">Quản lý đào
			...
			<li class="m-menu__item m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a
					href="javascript:;" class="m-menu__link m-menu__toggle"><i
						class="m-menu__link-icon flaticon-interface-1"></i><span class="m-menu__link-text">Quản lý tổng
			...
			<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a
					href="javascript:;" class="m-menu__link m-menu__toggle"><i
						class="m-menu__link-icon flaticon-network"></i><span class="m-menu__link-text">Thống kê / biểu
				...
				<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
					<ul class="m-menu__subnav">
						...
						<li class="m-menu__item " aria-haspopup="true"><a
								href="{{url('chart/bieu-do-bao-cao-ngan-sach')}}" class="m-menu__link "><i
									class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
									class="m-menu__link-text">Biểu đồ báo cáo ngân sách</span></a></li>
						<li class="m-menu__item " aria-haspopup="true"><a
								href="{{url('chart/bieu-do-ket-qua-tuyen-sinh')}}" class="m-menu__link "><i
									class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
									class="m-menu__link-text">Biểu đồ kết quả tuyển sinh</span></a></li>
						<li class="m-menu__item " aria-haspopup="true"><a
								href="{{url('chart/bieu-do-sinh-vien-dang-theo-hoc')}}" class="m-menu__link "><i
									class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
									class="m-menu__link-text">Biểu đồ sinh viên đang theo học</span></a></li>
						<li class="m-menu__item " aria-haspopup="true"><a
								href="{{url('chart/bieu-do-so-luong-tot-nghiep')}}" class="m-menu__link "><i
									class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
									class="m-menu__link-text">Biểu đồ số lượng tốt nghiệp</span></a></li>
						<li class="m-menu__item " aria-haspopup="true"><a
								href="{{url('chart/bieu-do-hop-tac-quoc-te')}}" class="m-menu__link "><i
									class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
			...
			<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a
					href="javascript:;" class="m-menu__link m-menu__toggle"><i
						class="m-menu__link-icon flaticon-calendar"></i><span class="m-menu__link-text">Bảng tin điện
			...
			<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a
				...
				<div class="m-menu__submenu "><span class="m-menu__arrow"></span>
					<ul class="m-menu__subnav">
						...
						<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"
							m-menu-submenu-toggle="hover"><a href="{{url('feedback/nhan-tin-bao-loi-he-thong')}}"
								class="m-menu__link m-menu__toggle"><i
									class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
