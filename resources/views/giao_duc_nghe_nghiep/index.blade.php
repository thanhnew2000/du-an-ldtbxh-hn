...
<div class="m-content container-fluid">
    ...
    <form action="{{route('layformbieumau.quan-ly-giao-duc-nghe-nghiep')}}" method="post">
        @csrf
    ...
    <form action="{{route('import.error.quan-ly-giao-duc-nghe-nghiep')}}" id="form_import_file" method="post"
    ...
    <form action="{{route('exportdata.quan-ly-giao-duc-nghe-nghiep')}}" id="" method="post" enctype="multipart/form-data">
        @csrf
