                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->ke_hoach_tuyen_sinh_cao_dang}}"
                        name="ke_hoach_tuyen_sinh_cao_dang" class="form-control"> @error('ke_hoach_tuyen_sinh_cao_dang')
                    ...
                    <td><input type="number" min="0" step="1"
                        ...
                        class="form-control"> @error('ke_hoach_tuyen_sinh_trung_cap')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->ke_hoach_tuyen_sinh_so_cap}}"
                        name="ke_hoach_tuyen_sinh_so_cap" class="form-control"> @error('ke_hoach_tuyen_sinh_so_cap')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->ke_hoach_tuyen_sinh_khac}}"
                        name="ke_hoach_tuyen_sinh_khac" class="form-control"> @error('ke_hoach_tuyen_sinh_khac')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                  </tr>
                </tbody>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_luong_sv_nu_Cao_dang}}"
                        name="so_luong_sv_nu_Cao_dang" class="form-control"> @error('so_luong_sv_nu_Cao_dang')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_luong_sv_nu_Trung_cap}}"
                        name="so_luong_sv_nu_Trung_cap" class="form-control"> @error('so_luong_sv_nu_Trung_cap')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_luong_sv_nu_So_cap}}"
                        name="so_luong_sv_nu_So_cap" class="form-control"> @error('so_luong_sv_nu_So_cap')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_luong_sv_nu_khac}}"
                        name="so_luong_sv_nu_khac" class="form-control"> @error('so_luong_sv_nu_khac')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                  </tr>
                  <tr>
                    ...
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_luong_sv_dan_toc_Cao_dang}}"
                        name="so_luong_sv_dan_toc_Cao_dang" class="form-control"> @error('so_luong_sv_dan_toc_Cao_dang')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                    <td><input type="number" min="0" step="1"
                        value="{{$datatuyensinhid->so_luong_sv_dan_toc_Trung_cap}}" name="so_luong_sv_dan_toc_Trung_cap"
                        class="form-control"> @error('so_luong_sv_dan_toc_Trung_cap')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_luong_sv_dan_toc_So_cap}}"
                        name="so_luong_sv_dan_toc_So_cap" class="form-control"> @error('so_luong_sv_dan_toc_So_cap')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_luong_sv_dan_toc_khac}}"
                        name="so_luong_sv_dan_toc_khac" class="form-control"> @error('so_luong_sv_dan_toc_khac')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                  ...
                  <tr>
                    ...
                    <td><input type="number" min="0" step="1"
                        ...
                        name="so_luong_sv_ho_khau_HN_Cao_dang" class="form-control"> @error('so_luong_sv_ho_khau_HN_Cao_dang')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                    <td><input type="number" min="0" step="1"
                        value="{{$datatuyensinhid->so_luong_sv_ho_khau_HN_Trung_cap}}"
                        name="so_luong_sv_ho_khau_HN_Trung_cap" class="form-control"> @error('so_luong_sv_ho_khau_HN_Trung_cap')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                    <td><input type="number" min="0" step="1"
                        value="{{$datatuyensinhid->so_luong_sv_ho_khau_HN_So_cap}}" name="so_luong_sv_ho_khau_HN_So_cap"
                        class="form-control"> @error('tong_so_dan_toc')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_luong_sv_ho_khau_HN_khac}}"
                        name="so_luong_sv_ho_khau_HN_khac" class="form-control"> @error('so_luong_sv_ho_khau_HN_khac')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                  </tr>
                  <tr>
                    ...
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_luong_sv_Cao_dang}}"
                        name="so_luong_sv_Cao_dang" class="form-control"> @error('so_luong_sv_Cao_dang')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_luong_sv_Trung_cap}}"
                        name="so_luong_sv_Trung_cap" class="form-control"> @error('so_luong_sv_Trung_cap')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_luong_sv_So_cap}}"
                        name="so_luong_sv_So_cap" class="form-control"> @error('so_luong_sv_So_cap')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_luong_sv_he_khac}}"
                        name="so_luong_sv_he_khac" class="form-control"> @error('so_luong_sv_he_khac')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                  </tr>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="number" value="{{$datatuyensinhid->ho_khau_HN_THCS_Trung_cap}}" min="0" step="1"
                        name="ho_khau_HN_THCS_Trung_cap" class="form-control"> @error('ho_khau_HN_THCS_Trung_cap')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                  </tr>
                  <tr>
                    ...
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_Tot_nghiep_THCS}}"
                        name="so_Tot_nghiep_THCS" class="form-control"> @error('so_Tot_nghiep_THCS')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                  ...
                  <tr>
                    ...
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_Tot_nghiep_THPT}}"
                        name="so_Tot_nghiep_THPT" class="form-control"> @error('so_Tot_nghiep_THPT')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                  </tr>
                </tbody>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_tuyen_moi_Cao_dang}}"
                        name="so_tuyen_moi_Cao_dang" class="form-control"> @error('so_tuyen_moi_Cao_dang')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                  </tr>
                  <tr>
                    ...
                    <td><input type="number" min="0" step="1" value="{{$datatuyensinhid->so_lien_thong_Cao_dang}}"
                        name="so_lien_thong_Cao_dang" class="form-control"> @error('so_lien_thong_Cao_dang')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                  </tr>
                </tbody>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input value="{{$datatuyensinhid->tong_so_nu}}" name="tong_so_nu" type="number" min="0" step="1"
                        class="form-control"> @error('tong_so_nu')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                  </tr>
                  <tr>
                    ...
                    <td><input value="{{$datatuyensinhid->tong_so_dan_toc}}" name="tong_so_dan_toc" type="number"
                        min="0" step="1" class="form-control"> @error('tong_so_dan_toc')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                  </tr>
                  <tr>
                    ...
                    <td><input value="{{$datatuyensinhid->tong_ho_khau_HN}}" name="tong_ho_khau_HN" type="number"
                        min="0" step="1" class="form-control"> @error('tong_ho_khau_HN')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input value="{{$datatuyensinhid->tong_so_tuyen_sinh}}" name="tong_so_tuyen_sinh" type="number"
                        min="0" step="1" class="form-control"> @error('tong_so_tuyen_sinh')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror</td>
                  </tr>
                </tbody>
