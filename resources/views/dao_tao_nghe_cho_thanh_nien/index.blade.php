...
@section('title', "Tổng hợp đào tạo nghề cho thanh niên")
@section('style')
...
<div class="m-content container-fluid">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">
                       Tổng hợp<small>đào tạo nghề cho thanh niên</small>
                    </h3>
                </div>
            </div>
        </div>
    ...
    <form action="{{route('layformbieumau-dao-tao-thanh-nien')}}" method="post">
        @csrf
    ...
    <form action="{{route('exportdata-dao-tao-thanh-nien')}}" id="" method="post" enctype="multipart/form-data">
        @csrf
