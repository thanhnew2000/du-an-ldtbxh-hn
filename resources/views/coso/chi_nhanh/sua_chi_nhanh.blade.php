        ...
        <div class="main-form row d-flex justify-content-around">
            <div class="col-left col-lg-5">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <input type="text" name="dia_chi" id="" class="form-control" value="{{ $item->dia_chi }}">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select class="form-control" name="chi_nhanh_chinh">
                        <option selected value="{{ $item->chi_nhanh_chinh }}">@if ($item->chi_nhanh_chinh == 1)
                            Chi nhánh chính
                            @else
                            Chi nhánh phụ
                            @endif</option>
            ...
            <div class="col-right col-lg-5">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <input type="text" name="hotline" id="" class="form-control" value="{{ $item->hotline }}">
                    <p id="helpId" class="form-text text-danger">
                        @error('hotline')
                        {{ $message }}
                        @enderror
