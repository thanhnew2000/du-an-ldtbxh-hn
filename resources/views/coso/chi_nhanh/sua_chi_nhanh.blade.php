        ...
        <div class="main-form row d-flex justify-content-around">
            <div class="col-left col-lg-5">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select class="form-control" name="chi_nhanh_chinh">
                        <option selected disabled>Chọn loại chi nhánh</option>
            ...
            <div class="col-right col-lg-5">
                <div class="form-group col-lg-12">
                    ...
                    <input type="text" name="ma_chung_nhan_dang_ki_hoat_dong" id="" class="form-control" placeholder=""
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select class="form-control" name="da_duoc_cap" id="">
                        <option selected disabled>Trạng thái câp</option>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <input type="text" name="hotline" id="" class="form-control" placeholder=""
                        aria-describedby="helpId">
                    <p id="helpId" class="form-text text-danger">
                        @error('hotline')
                        {{ $message }}
