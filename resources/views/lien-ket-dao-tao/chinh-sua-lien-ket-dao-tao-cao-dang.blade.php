                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="number" min="0" step="1" name="chi_tieu"
                                                class="form-control name-field" value="{{$data->chi_tieu}}">
                                            @error('chi_tieu')
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" min="0" step="1" name="thuc_tuyen"
                                                class="form-control name-field" value="{{$data->thuc_tuyen}}">
                                            @error('thuc_tuyen')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" min="0" step="1" name="so_HSSV_tot_nghiep"
                                                class="form-control name-field" value="{{$data->so_HSSV_tot_nghiep}}">
