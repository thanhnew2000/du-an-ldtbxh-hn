                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control nganh_nghe select2" onchange="getNgheTheoCapBac(this)"
                                    ...
                                    name="{{strlen($params['nganh_nghe'])==3?'nganh_nghe':''}}" @endif id="nghe_cap_2">
                                    <option value="" selected>Chọn</option>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control select2" name="dot" id="dot">
                                    ...
                                    <option @if (isset($params['dot'])) {{( $params['dot'] ==  2 ) ? 'selected' : ''}}
                                        @endif value="2">Đợt 2
                                    </option>
                                </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control nganh_nghe select2" onchange="getNgheTheoCapBac(this)"
                                    @if(isset($params['nganh_nghe']))
                                    name="{{strlen($params['nganh_nghe'])==5?'nganh_nghe':''}}" @endif id="nghe_cap_3">
                                    <option value="" selected>Chọn</option>
...
<section class="action-nav d-flex align-items-center justify-content-between mt-4 mb-4">
    ...
    <div class="col-lg-2">
        <a href="javascript:" data-toggle="modal" id="upImport-file" data-target="#moDalImport"><i class="fa fa-upload"
                aria-hidden="true"></i>
...
<form action="{{route('import.error.lien-ket-dao-tao')}}" id="my_form_kqts_import" method="post"
...
function closeModal(id) {
    ...
    $("#file_import_id").change(function() {
        ...
        if($("#file_import_id")[0].files.length === 0){
            ...
            axios.post("{{route('importketqua.lien-ket-dao-tao')}}", formData,{
                headers: {
