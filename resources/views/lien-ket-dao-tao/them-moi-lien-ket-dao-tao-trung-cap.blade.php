...
@section('title', "Thêm liên kết đào tạo Trung Cấp")
@section('style')
<style>
    .batbuoc {
        color: red;
...
<div class="m-content container-fluid">
    <form action="{{route('xuatbc.post-them-lien-ket-dao-tao', ['id' => 5])}}" id="validate-form-add" novalidate
        method="post">
        @csrf
        <div class="m-portlet">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <h3 class="m-portlet__head-text">
                            Thêm mới liên kết đào tạo Trung Cấp
                        </h3>
                    </div>
                </div>
            </div>
                        ...
                        <div class="tab-content">
                            <table class="table m-table m-table--head-bg-brand ">
                                <tbody>
                                    <tr>
                                        <td>Chỉ tiêu</td>
                                        <td><input type="number" min="0" step="1" name="chi_tieu"
                                    ...
                                    <tr>
                                        <td>Thực tuyển</td>
                                        <td><input type="number" min="0" step="1" name="thuc_tuyen"
                                                class="form-control name-field">
                                            @error('thuc_tuyen')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" min="0" step="1" name="so_HSSV_tot_nghiep"
                                                class="form-control name-field">
        ...
        <div class="row mt-4" style="float: right">
            <div class="col-md-12">
                <a style="color: white;"
                    href="{{route('xuatbc.tong-hop-lien-ket-dao-tao-trung-cap', ['id' => 5])}}"><button type="button"
...
@section('script')
<script>
    var routeCheck = "{{ route('xuatbc.check-ton-tai-lien-ket-dao-tao-trung-cap', ['id' => 5]) }}";
