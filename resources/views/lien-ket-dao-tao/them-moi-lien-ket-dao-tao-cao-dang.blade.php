...
@section('title', "Thêm liên kết đào tạo Cao Đẳng")
@section('style')
<style>
    .batbuoc {
        color: red;
...
<div class="m-content container-fluid">
    <form action="{{route('xuatbc.post-them-lien-ket-dao-tao', ['id' => 6])}}" id="validate-form-add" novalidate
        method="post">
        @csrf
        <div class="m-portlet">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <h3 class="m-portlet__head-text">
                            Thêm mới liên kết đào tạo Cao Đẳng
                        </h3>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-4" style="float: right">
            <div class="col-md-12">
                <a style="color: white;"
                    href="{{route('xuatbc.tong-hop-lien-ket-dao-tao-cao-dang', ['id' => 6])}}"><button type="button"
...
@section('script')
<script>
    var routeCheck = "{{ route('xuatbc.check-ton-tai-lien-ket-dao-tao-cao-dang', ['id' => 6]) }}";
