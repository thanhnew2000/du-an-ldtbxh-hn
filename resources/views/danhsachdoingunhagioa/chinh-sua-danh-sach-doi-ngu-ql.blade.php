...
@section('title', "Chỉnh sửa danh sách giáo viên")
@section('style')
@endsection
@section('content')
<div class="m-content container-fluid">
    <div class="header">
        <h2 class="header__title pt-5">
            Chỉnh sửa danh sách giáo viên
        </h2>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="m-portlet m-portlet--mobile m-portlet--body-progress-trinhdo">
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <span class="m-portlet__head-icon">
