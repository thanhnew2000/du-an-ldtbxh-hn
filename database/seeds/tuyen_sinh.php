...
class tuyen_sinh extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        for ($i = 0; $i < $limit; $i++){
            DB::table('tuyen_sinh')->insert([
                ...
                'so_tuyen_moi_Cao_dang' => rand(100,400),
                'so_lien_thong_Cao_dang' => rand(100,400),
                ...
                'so_Tot_nghiep_THCS' => rand(100,400),
                'so_Tot_nghiep_THPT' => rand(100,400),
